...
const STEPS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: 'Tick the rules you want on the right and adjust their numbers. Add rules for who may catch or pitch, or which positions a player can play. Tick the exemption on a catcher or pitcher rule so those players can repeat. Each rule has a priority (− and +): when the rules cannot all be met, higher-priority rules are satisfied first. The Preferences tab holds softer wishes, like a player who would like to play shortstop, which the solver honours when the rules allow.',
  },
  {
